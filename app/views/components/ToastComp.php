...
final class ToastComp
{
    ...
    private const array TOAST_TYPES = [
            'errors' => [
                    ...
                    'icon' => '/assets/icons/status/error-FFF.svg',
                    'alt' => 'Error'
            ],
            'info' => [
                    'bgColor' => 'bg-blue-600',
                    'hoverColor' => 'hover:bg-blue-700',
                    'icon' => '/assets/icons/status/info-FFF.svg',
                    'alt' => 'Info'
            ],
            'success' => [
                    'bgColor' => 'bg-green-600',
                    'hoverColor' => 'hover:bg-green-700',
                    'icon' => '/assets/icons/status/success-FFF.svg',
                    'alt' => 'Success'
            ]
    ];
    ...
    private static function renderToasts(array $msgs, string $cspNonce): void
    {
        ...
        <script nonce="<?= $cspNonce ?>">
            // IIFE: On page load, set timers for auto-dismiss and attach click handlers for manual dismiss
            (() => {
