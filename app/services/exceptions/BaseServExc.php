...
class BaseServExc extends RuntimeException
{
     ...
     *
     * Created since otherwise every service function that calling a repo function would need to
     * have the same try-catch block again and again, which is a lot of duplicate code.
     *
     ...
     * @throws BaseServExc subclass on error (AuthException, ProjectException etc.).
     */
